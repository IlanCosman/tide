...
tide_right_prompt_items status cmd_duration context jobs node virtual_env rustc pyenv php chruby go kubectl terraform vi_mode
...
tide_rustc_icon ''
tide_pyenv_bg_color 444444
tide_pyenv_color F74C00
tide_pyenv_icon ''
